...
function getRootAPIPath() {
  let braidService = process.env["BRAID_SERVICE"]
  if(typeof (braidService) === 'undefined') {
    braidService = "https://localhost:8080/api/jsonrpc"
  }
  console.log(`root api path: ${braidService}`)
  return braidService;
}
