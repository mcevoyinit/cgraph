...
function (url, onOpen, onClose, onError, transportOptions) {
   ...
   *
   */that.invoke = function (method, args) {var callbacks = bindCallbacks(args);if (callbacks) {return invokeForStream(method, args, callbacks);} else {return invokeForPromise(method, args);}};that.close = function () {client.close();};}; /**
