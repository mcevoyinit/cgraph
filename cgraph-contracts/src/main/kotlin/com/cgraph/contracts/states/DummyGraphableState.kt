...
data class DummyGraphableState(override val linearId: UniqueIdentifier) : GraphableState {
    override fun buildEntityMap(): MapOfMaps { return emptyMap() }
    override val participants: List<AbstractParty> = emptyList()
}

class DummyContract : Contract {
    companion object { @JvmStatic val ID = "com.cgraph.contracts.states.DummyContract" }
